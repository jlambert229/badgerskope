  (function () {
    ...
    var terms = [
      ...
      { term: 'Bioregulator', full: '', def: 'A very short peptide (2–4 amino acids) marketed for organ-specific support, often originating from Russian research (Khavinson peptides). Evidence is limited and mostly preclinical.' },
      { term: 'BPC', full: 'Body Protection Compound', def: 'A peptide fragment originally found in human stomach juice. BPC-157 is the most studied variant, researched for its potential effects on gut healing and tissue repair, mostly in animal models.' },
      ...
      { term: 'Certificate of Analysis', full: 'COA', def: 'A document from an independent lab confirming what is actually in a vial and its purity. A legitimate COA should come from a third-party lab, not the vendor itself.' },
      ...
      { term: 'Compounding pharmacy', full: '', def: 'A pharmacy that custom-mixes medications to order, sometimes used to prepare peptides. Quality and regulation vary significantly between compounding pharmacies.' },
      ...
      { term: 'Grey market', full: '', def: 'Products sold legally but outside official pharmaceutical channels, with uncertain quality and authenticity. Most “research peptides” fall into this category.' },
      ...
      { term: 'Homeostasis', full: '', def: 'The body’s tendency to maintain stable internal conditions (temperature, pH, blood sugar, etc.). Many peptides work by nudging the body back toward homeostatic balance.' },
      ...
      { term: 'In vitro', full: '', def: 'Experiments done in a test tube or petri dish, outside a living organism. “It worked in vitro” means it worked in a lab dish — not necessarily in a living body.' },
      ...
      { term: 'NAD+', full: 'Nicotinamide Adenine Dinucleotide', def: 'A coenzyme found in every living cell, essential for converting food into energy and repairing DNA. NAD+ levels decline with age, which has made it a target for longevity research.' },
      ...
      { term: 'Placebo', full: '', def: 'An inactive treatment (sugar pill or saline injection) used as a comparison in studies. The “placebo effect” is the real, measurable improvement some people experience from believing they received treatment.' },
      { term: 'Preclinical', full: '', def: 'Research done in animals or lab dishes before any human testing begins. Promising preclinical results are necessary but not sufficient — many compounds that work in mice fail in humans.' },
      ...
      { term: 'Secretagogue', full: '', def: 'A substance that triggers the body to release a specific hormone rather than replacing the hormone directly. Growth hormone secretagogues stimulate your own pituitary to produce more GH.' },
      { term: 'Senescent cells', full: '', def: 'Old, damaged cells that stop dividing but refuse to die. They accumulate with aging and secrete inflammatory signals that damage neighboring cells. Senolytics are drugs designed to clear them.' },
      ...
      { term: 'Telomerase', full: '', def: 'An enzyme that can rebuild telomeres, counteracting their natural shortening. Associated with longevity research, though the relationship between telomerase activity and lifespan is complex.' },
      ...
      { term: 'WADA', full: 'World Anti-Doping Agency', def: 'The international organization that decides which substances are banned in sport. Most research peptides, including GH secretagogues and SARMs, are on the WADA prohibited list.' }
    ];
